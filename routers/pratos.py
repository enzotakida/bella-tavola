        ...
        if prato["id"] == prato_id:
            if incluir_ingredientes:
                return {**prato, "ingredientes": {
                    1: ["Massa de pizza artesanal", "Molho de tomate", "Mussarela de búfala", "Manjericão fresco", "Azeite extra virgem"],
                    2: ["Espaguete grano duro", "Pancetta curada", "Gemas de ovo", "Queijo parmessao", "Pimenta preta moída"],
                    3: ["Massa fresca de lasanha", "Ragù à bolonhesa (carne bovina e suína)", "Molho bechamel", "Queijo"],
                    4: ["Biscoito champanhe", "Café", "Queijo mascarpone", "Cacau em pó", "licor"],
                    5: ["Massa de pizza artesanal", "Molho de tomate", "Mussarela", "Alcachofrinhas", "Presunto cozido", "Cogumelos frescos", "Azeitonas pretas"],
                    6: ["Creme de leite fresco", "Açúcar", "Fava de baunilha", "Gelatina", "Calda artesanal de frutas vermelhas"]
